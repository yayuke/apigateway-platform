-- =============================================
-- 国产化API网关平台 - MySQL 5.6数据库初始化脚本
-- 版本: 1.0.0
-- 数据库: MySQL 5.6+
-- =============================================

-- 创建数据库
CREATE DATABASE IF NOT EXISTS `apigateway` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `apigateway`;
...
CREATE TABLE `datasource_config` (
    ...
    `ds_type` VARCHAR(50) NOT NULL COMMENT '数据库类型',
...
-- 初始化管理员用户 (密码: admin123, 使用MD5简化版)
-- MD5('admin123') = 0192023a7bbd73250516f069df18b500
INSERT INTO `sys_user` (`id`, `username`, `password`, `real_name`, `status`)
VALUES (1, 'admin', '0192023a7bbd73250516f069df18b500', '管理员', 1);

-- 初始化默认数据源配置
INSERT INTO `datasource_config` (`id`, `ds_name`, `ds_type`, `jdbc_url`, `username`, `password`, `status`, `health_status`)
VALUES (1, '主数据源', 'MYSQL', 'jdbc:mysql://localhost:3306/apigateway?useUnicode=true&characterEncoding=utf8', 'root', '123456', 1, 1);
